  ...
  return (
    ...
    <div className="maincontainer" id="quoteSummary">
      <div style={{ marginTop: '20px' }}>
        ...
        <div style={{ width: '50%', float: 'left' }}>
          ...
          <table className="quote-table">
            <tbody>
              ...
              <tr>
                <td><strong>Primary Named Insured</strong></td>
              ...
              <tr>
                <td><strong>Address Description</strong></td>
                <td></td>
              </tr>
              <tr>
                <td><strong>Underwriting Company</strong></td>
          ...
          <table className="premium-table">
            ...
            <tbody>
              ...
              <tr>
                <td colSpan="2" style={{ textAlign: 'right' }}>$173.00</td>
              </tr>
              <tr>
        ...
        {/* Cost Summary */}
        <div style={{ width: '35%', float: 'right', marginTop: '52px', marginRight: '100px' }}>
          <table className="cost-summary-table">
            <tbody>
              <tr>
                <td style={{ textAlign: 'right' }}><strong>Total Premium</strong></td>
                <td style={{ textAlign: 'right' }}>$346.00</td>
              </tr>
              <tr>
                <td style={{ textAlign: 'right' }}><strong>Taxes & Surcharges</strong></td>
                <td style={{ textAlign: 'right' }}>$23.00</td>
              </tr>
              <tr>
                <td style={{ textAlign: 'right' }}><strong>Total Cost</strong></td>
